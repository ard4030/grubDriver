...
const AllCont = () => {
  ...
  const getBankAccounts = async () => {
    ...
    if(res.success){
        if(res.data.code === 1){
            ...
            setMyData({...myData,acc_id:res.data.details.rows[0].acc_id})
        }else{
  ...
  return (
    <div className={styles.allCont}>
      ...
      <div className={styles.myContent}>
        {
          ...
          className={styles.rqw}>Request Withdrawal</button>
        }
        <TableView
        columns={columns}
        api="/getWithdrawals"
      ...
      <MyModal 
         open={open}
         title={`Widthdrawal #${details?details.withdrawal_id:""}`}
      ...
      <MyModal 
        ...
        >
          <div className={styles.el1}>
            <span className={styles.el2}>Amount</span>
