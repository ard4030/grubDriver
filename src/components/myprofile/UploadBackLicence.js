  ...
  return (
    <div className={styles.uploadLicence}>
        <div className={styles.befo}>
          ...
          {
          details.documents && details.documents.licence_back && details.documents.licence_back.name?
            <div className={styles.showImgLicense}>
              <div className={styles.contImage}>
                <Image 
                src={details.documents.licence_back.url}
                fill
                alt='licence'
                 />
              </div>
          ...
          <>
            {
              ...
              <>
                ...
                type={"file"} />
                <VscArrowUp />
                <span className={styles.spnOut}>Upload Back Licence</span>
              </>
            }
          </>
          }
...
export default UploadBackLicence